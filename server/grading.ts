...
// Highly precise checker for blank questions to avoid false positives (e.g. "g" matching "garage" or "w" matching "water")
function checkAnswer(userAnswer: string, correctAnswer: string): boolean {
  ...
  // Single word: exact match is required! (To avoid "dish" matching "dishwasher" or "water" matching "landscaping" etc., or vice-versa)
  return normUser === normCorrect;
}
